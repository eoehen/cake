...
namespace Cake.Common.Security
{
    ...
    public class DirectoryHashCalculator
    {
            ...
            HashAlgorithm hashAlgorithm)
        {
            ...
            using (var incrementalDirectoryHash = _hashAlgorithmBuilder.GetHashAlgorithm(hashAlgorithm))
            {
            ...
            HashAlgorithm hashAlgorithm)
        {
            ...
            using (var incrementalFileHash = _hashAlgorithmBuilder.GetHashAlgorithm(hashAlgorithm))
            {
                ...
                using (var hashAlgorithmInstance = _hashAlgorithmBuilder.GetHashAlgorithm(hashAlgorithm))
                {
